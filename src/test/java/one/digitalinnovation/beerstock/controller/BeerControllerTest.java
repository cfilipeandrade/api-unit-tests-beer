...
public class BeerControllerTest {
    ...
    void whenPATCHIsCalledToIncrementGreatherThanMaxThenBadRequestStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(((MockHttpServletRequestBuilder) patch(BEER_API_URL_PATH + "/" + VALID_BEER_ID + BEER_API_SUBPATH_INCREMENT_URL)
                .contentType(MediaType.APPLICATION_JSON)).content(asJsonString(quantityDTO))).andExpect(status().isBadRequest());
    }
    ...
    void whenPATCHIsCalledWithInvalidBeerIdToIncrementThenNotFoundStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(((MockHttpServletRequestBuilder) patch(BEER_API_URL_PATH + "/" + INVALID_BEER_ID + BEER_API_SUBPATH_INCREMENT_URL)
                .contentType(MediaType.APPLICATION_JSON))
    ...
    void whenPATCHIsCalledToDecrementDiscountThenOKstatusIsReturned() throws Exception {
        ...
        mockMvc.perform(((MockHttpServletRequestBuilder) patch(BEER_API_URL_PATH + "/" + VALID_BEER_ID + BEER_API_SUBPATH_DECREMENT_URL)
                .contentType(MediaType.APPLICATION_JSON))
                .content(asJsonString(quantityDTO))).andExpect(status().isOk())
                .andExpect(jsonPath("$.name", is(beerDTO.getName())))
                .andExpect(jsonPath("$.brand", is(beerDTO.getBrand())))
    ...
    void whenPATCHIsCalledWithInvalidBeerIdToDecrementThenNotFoundStatusIsReturned() throws Exception {
        ...
        mockMvc.perform(((MockHttpServletRequestBuilder) patch(BEER_API_URL_PATH + "/" + INVALID_BEER_ID + BEER_API_SUBPATH_DECREMENT_URL)
                .contentType(MediaType.APPLICATION_JSON))
                .content(asJsonString(quantityDTO)))
                .andExpect(status().isNotFound());
    }
